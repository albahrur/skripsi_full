...
@app.route('/')
def main():
    title = "ScanRice - Klasifikasi Penyakit Daun Padi"
...
def klasifikasi():
    title = "klasifikasi"
    return render_template("klasifikasi.html",title=title)

@app.route('/tentang')
def tentang():
    title = "tentang"
    return render_template('tentang.html',title=title)

@app.route('/penyakit')
def penyakit():
    title = "penyakit"
    return render_template('penyakit.html',title=title)
